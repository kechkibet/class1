...
public class Class1TestContainer extends TestContainer {

    public Class1TestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/class1/app.properties",
    ...
    public static class Common extends Class1TestContainer {

        public static final Class1TestContainer.Common INSTANCE = new Class1TestContainer.Common();
